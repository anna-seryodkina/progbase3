...
namespace ConsoleProject
{
    public class OpenUserListDialog : Dialog
    {
        ...
        private void OnSearch()
        {
            ...
            this.allUsersListView.SetSource(userRepo.GetPageSearch(forSearch, pageNum, pageSize));
        }
        ...
        private void UpdateCurrentPage()
        {
            ...
            if(onSearchMode)
            {
                totalPages = (int)userRepo.GetTotalPagesSearch(forSearch, pageSize);
            }
            else
            {
                totalPages = (int)userRepo.GetTotalPages(pageSize);
            }
